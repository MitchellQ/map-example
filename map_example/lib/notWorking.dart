...
class NotWorking extends StatefulWidget {
  @override
  _NotWorkingState createState() => _NotWorkingState();
}

class _NotWorkingState extends State<NotWorking> with TickerProviderStateMixin {
  ...
  ///To see the working example comment it out in main.dart
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Not Working Example')),
      body: currentPage,
